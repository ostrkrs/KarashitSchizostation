...
/obj/item/food/raw_blood_sausage/Initialize(mapload)
	. = ..()
	AddElement(/datum/element/dryable, /obj/item/food/blood_sausage)

/obj/item/food/blood_sausage
	name = "blood sausage"
	desc = "A coarse dry-cured blood sausage."
	icon = 'icons/obj/food/meat.dmi'
...
/obj/item/food/fried_blood_sausage
	...
	desc = "A blood sausage, battered and deep fried."
	icon = 'icons/obj/food/meat.dmi'
...
/obj/item/food/moonfish_eggs
	name = "moonfish eggs"
	gender = PLURAL
	desc = "The moonfish lays large, translucent blue eggs which are prized in cooking. Their flavour is similar to caviar, but generally is described as deeper and more complex."
	icon = 'icons/obj/food/meat.dmi'
...
/obj/item/food/moonfish_caviar
	...
	desc = "A rich paste made from moonfish eggs."
	icon = 'icons/obj/food/meat.dmi'
