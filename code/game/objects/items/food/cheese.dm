...
/obj/item/food/herby_cheese
	name = "herby cheese"
	desc = "A soft cheese mixed with a variety of herbs."
...
/obj/item/food/grilled_cheese
	name = "grilled cheese"
	desc = "\"Does she know how to make grilled cheese?\""
...
/obj/item/food/baked_cheese_platter
	name = "baked cheese &amp toast"
	desc = "Usually served with crispy bread slices for dipping, \
