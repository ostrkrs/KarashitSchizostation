...
/obj/item/food/big_baked_rice
	name = "big baked rice"
	desc = "Can be filled with a variety of vegetable fillings to make a delicious meal to share. \
		Potatoes are also often layered on the bottom of the cooking vessel to create a flavourful \
		crust which is hotly contested amongst diners."
	icon = 'icons/obj/food/martian.dmi'
