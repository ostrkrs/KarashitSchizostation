...
/obj/item/food/salad/kenyan
	name = "kenyan salad"
	desc = "A fresh, tangy salad made from tomatoes, onions, chili, cilantro, and lime juice. Known as kachumbari in Kenya, \
		it's a popular side dish for grilled meats and other hearty mains."
	icon_state = "kenyan_salad"
	food_reagents = list(
		/datum/reagent/consumable/nutriment = 6,
...
/obj/item/food/salad/caprese_salad
	name = "caprese salad"
	desc = "Caprese salad has become a favourite aboard the colonized \
		galaxy due to how simple it is to prepare yet how tasty it is."
