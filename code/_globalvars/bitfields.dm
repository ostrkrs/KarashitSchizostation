...
DEFINE_BITFIELD(bodyshape, list(
	...
	"BODYSHAPE_SERPENTID" = BODYSHAPE_SERPENTID,
))
...
DEFINE_BITFIELD(supports_variations_flags, list(
	...
	"CLOTHING_SERPENTID_VARIATION" = CLOTHING_SERPENTID_VARIATION,
	"CLOTHING_SERPENTID_VARIATION_NO_NEW_ICON" = CLOTHING_SERPENTID_VARIATION_NO_NEW_ICON,
))
