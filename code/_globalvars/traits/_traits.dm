...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_PROSTHETIC_LIMB" = TRAIT_PROSTHETIC_LIMB,
		"TRAIT_PULL_BLOCKED" = TRAIT_PULL_BLOCKED,
		"TRAIT_PUSHIMMUNE" = TRAIT_PUSHIMMUNE,
		"TRAIT_QUADRUPLE_AMPUTEE" = TRAIT_QUADRUPLE_AMPUTEE,
		...
		"TRAIT_TRANSHUMANIST" = TRAIT_TRANSHUMANIST,
