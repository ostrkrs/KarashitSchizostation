...
GLOBAL_LIST_INIT(ship_numerals, greek_letters + phonetic_alphabet + numbers_as_words + generate_number_strings())
GLOBAL_LIST_INIT(ship_prefixes, world.file2list("strings/ship_prefixes.txt"))
GLOBAL_LIST_INIT(ship_suffixes, world.file2list("strings/ship_suffixes.txt"))
