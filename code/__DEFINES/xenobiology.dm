...
#define NO_SPAWN 0
/// Mob can spawned with a gold slime core with phoron reaction as a hostile creature
...
/// Jelly species slime ability that causes complex effects that require phoron jelly
