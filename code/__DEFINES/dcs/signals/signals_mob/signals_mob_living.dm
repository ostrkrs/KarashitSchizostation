...
///Called when creep/walk intents are toggled.
#define COMSIG_MOVE_INTENT_CREEPWALK_TOGGLED "move_intent_creepwalk_toggled"
///Called when walk/run intents are toggled.
#define COMSIG_MOVE_INTENT_WALKRUN_TOGGLED "move_intent_walkrun_toggled"
