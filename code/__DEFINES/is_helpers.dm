...
#define iscash(A) (istype(A, /obj/item/coin) || istype(A, /obj/item/stack/spacecash) || istype(A, /obj/item/poker_chip))
...
#define is_criminalist_job(job_type) (istype(job_type, /datum/job/criminalist))
...
#define is_area_nearby_station(checked_area) (istype(checked_area, /area/space) || istype(checked_area, /area/space/nearstation))
