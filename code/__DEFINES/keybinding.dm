...
#define COMSIG_KB_LIVING_TOGGLEMOVEINTENT_CYCLE	"keybinding_living_togglethrowmode_cycle"
...
#define COMSIG_KB_SILICON_UNDEPLOY_DOWN "keybinding_silicon_undeploy_down"
