...
/datum/dna_block/feature/serpentid_color
	block_length = DNA_BLOCK_SIZE_COLOR
	feature_key = FEATURE_SERPENTID_COLOR

/datum/dna_block/feature/serpentid_color/create_unique_block(mob/living/carbon/human/target)
	return sanitize_hexcolor(target.dna.features[FEATURE_SERPENTID_COLOR], include_crunch = FALSE)
