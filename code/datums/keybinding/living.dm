...
// CYCLE MOVE INTENTS
/datum/keybinding/living/cycle_move_intents
	hotkey_keys = list("`")
	name = "toggle_move_intent_cycle"
	full_name = "Press to cycle movement speed"
...
// WALK/RUN
/datum/keybinding/living/toggle_move_intent_walk_run
	hotkey_keys = list("Ctrl")
	name = "toggle_move_intent_walk_run"
	full_name = "Hold to switch walking/running"
...
/datum/keybinding/living/toggle_move_intent_walk_run/down(client/user, turf/target)
	...
	if(.)
		return
	var/mob/living/M = user.mob
	M.toggle_move_intent_walk_run()
	return TRUE

/datum/keybinding/living/toggle_move_intent_walk_run/up(client/user, turf/target)
	. = ..()
	var/mob/living/M = user.mob
	M.toggle_move_intent_walk_run()
	return TRUE

/datum/keybinding/living/toggle_move_intent_walk_run_alternative
	hotkey_keys = list("Unbound")
	name = "toggle_move_intent_walk_run_alt"
	full_name = "Press to switch walking/running"
	description = "Pressing this switch between walking and running, does not cycle back"
	keybind_signal = COMSIG_KB_LIVING_TOGGLEMOVEINTENTALT_UP

/datum/keybinding/living/toggle_move_intent_walk_run_alternative/up(client/user, turf/target)
	. = ..()
	if(.)
		return
	var/mob/living/M = user.mob
...
// CREEP/WALK
/datum/keybinding/living/toggle_move_intent_creep_walk
	hotkey_keys = list("Alt")
	name = "toggle_move_intent_creep_walk"
	full_name = "Hold to switch creeping/walking"
...
/datum/keybinding/living/toggle_move_intent_creep_walk/down(client/user, turf/target)
	...
	if(.)
		return
	var/mob/living/M = user.mob
	M.toggle_move_intent_creep_walk()
	return TRUE

/datum/keybinding/living/toggle_move_intent_creep_walk/up(client/user, turf/target)
	. = ..()
	var/mob/living/M = user.mob
	M.toggle_move_intent_creep_walk()
	return TRUE

/datum/keybinding/living/toggle_move_intent_creep_walk_alternative
	hotkey_keys = list("Unbound")
	name = "toggle_move_intent_creep_walk_alt"
	full_name = "Press to switch creeping/walking"
