/*
	...
	or under other certain conditions (thrown hard against a wall, sustained exposure to phoron fire, etc). Wounds are categorized by the three following criteria:
