...
/datum/config_entry/number/movedelay/run_delay/ValidateAndSet()
	. = ..()
	var/datum/movespeed_modifier/config_creep_walk_run/M = get_cached_movespeed_modifier(/datum/movespeed_modifier/config_creep_walk_run/run)
	M.sync()
...
/datum/config_entry/number/movedelay/walk_delay/ValidateAndSet()
	. = ..()
	var/datum/movespeed_modifier/config_creep_walk_run/M = get_cached_movespeed_modifier(/datum/movespeed_modifier/config_creep_walk_run/walk)
	M.sync()

/datum/config_entry/number/movedelay/creep_delay
	integer = FALSE

/datum/config_entry/number/movedelay/creep_delay/ValidateAndSet()
	. = ..()
	var/datum/movespeed_modifier/config_creep_walk_run/M = get_cached_movespeed_modifier(/datum/movespeed_modifier/config_creep_walk_run/creep)
	M.sync()
