...
/datum/reagent/eigenstate
	name = "Eigenstasium"
	description = "A strange mixture formed from a controlled reaction of bluespace with phoron, that causes localised eigenstate fluctuations within the patient"
