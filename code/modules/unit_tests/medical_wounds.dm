...
/// This test is used for making sure species with bones but no flesh (skeletons) can only suffer BONE_WOUNDS, and nothing tagged with FLESH_WOUND (it's possible to require both)
