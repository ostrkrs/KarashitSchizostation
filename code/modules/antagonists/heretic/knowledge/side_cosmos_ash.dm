...
/datum/heretic_knowledge/summon/fire_shark
	...
	desc = "Allows you to transmute a pool of ash, a liver, and a sheet of phoron into a Fire Shark. \
		Fire Sharks are fast and strong in groups, but die quickly. They are also highly resistant against fire attacks. \
		Fire Sharks inject phlogiston into its victims and spawn phoron once they die."
...
/datum/heretic_knowledge/eldritch_coin
	name = "Eldritch Coin"
	desc = "Allows you to transmute a sheet of phoron and a diamond to create an Eldritch Coin. \
