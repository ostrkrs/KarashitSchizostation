...
/obj/item/fish/moonfish
	...
	fish_id = "moonfish"
	desc = "A disc-shaped fish  roughly the size of a tuna. Highly prized in ocean-worlds colonial cuisine for their large eggs."
...
/obj/item/fish/moonfish/dwarf
	...
	desc = "Ordinarily in the wild, the moonfish is around the size of a tuna, however through selective breeding a smaller breed suitable for being kept as an aquarium pet has been created."
