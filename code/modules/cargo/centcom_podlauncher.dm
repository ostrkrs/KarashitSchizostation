...
/datum/centcom_podlauncher/ui_data(mob/user) //Sends info about the pod to the UI.
	...
	data["create_sparks"] = temp_pod.create_sparks //If true, the pod will create sparks before being deleted. This might cause fires if there is phoron in the air.
