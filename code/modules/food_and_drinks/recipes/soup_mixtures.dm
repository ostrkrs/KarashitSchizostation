...
// Root Dumpling soup
/datum/reagent/consumable/nutriment/soup/root_dumplings
	name = "root dumpling soup"
	description = "A bowl of rich, meaty root dumpling soup."
	data = list("bone broth" = 1, "onion" = 1, "potato" = 1)
	color = "#7B453B"

/datum/glass_style/has_foodtype/soup/root_dumplings
	required_drink_type = /datum/reagent/consumable/nutriment/soup/root_dumplings
	icon_state = "root_dumplings"
	drink_type = MEAT | VEGETABLES | NUTS

/datum/chemical_reaction/food/soup/root_dumplings
	required_reagents = list(
		/datum/reagent/water = 40,
		/datum/reagent/consumable/soysauce = 10,
	)
	required_ingredients = list(
		...
		/obj/item/food/grown/onion = 1,
		/obj/item/food/root_dumplings = 1,
	)
	results = list(
		/datum/reagent/consumable/nutriment/soup/root_dumplings = 30,
		/datum/reagent/water = 10,
	)
	ingredient_reagent_multiplier = 0.5
...
/datum/reagent/consumable/nutriment/soup/meatball_noodles
	...
	description = "A hearty noodle soup made from meatballs and root pasta in a rich broth. Commonly topped with a handful of chopped nuts."
...
/datum/crafting_recipe/food/reaction/soup/root_dumplings
	reaction = /datum/chemical_reaction/food/soup/root_dumplings
	category = CAT_CAVER
...
/datum/reagent/consumable/nutriment/soup/oat_stew
	name = "Oat stew"
	description = "A spicy bean stew with lots of veggies, commonly served as a filling and satisfying meal with rice or bread."
	data = list("oats" = 1, "sweet potato" = 1, "carrot" = 1, "parsnip" = 1, "pumpkin" = 1)
	color = "#CAA94E"

/datum/glass_style/has_foodtype/soup/oat_stew
	required_drink_type = /datum/reagent/consumable/nutriment/soup/oat_stew
	name = "oat stew"
	icon_state = "oat_stew"
	drink_type = VEGETABLES | GRAIN

/datum/chemical_reaction/food/soup/oat_stew
	required_reagents = list(/datum/reagent/water = 50)
	required_ingredients = list(
	...
	results = list(
		/datum/reagent/consumable/nutriment/soup/oat_stew = 30,
	)
	percentage_of_nutriment_converted = 0.1
...
/datum/reagent/consumable/nutriment/soup/fire_soup
	name = "Heartburn soup"
	description = "Heartburn soup is a cold soup dish that originated amongst the settlers, \
...
// Rice Porridge again but sweet
/datum/reagent/consumable/nutriment/soup/sweet_rice_porridge
	name = "Sweet Rice Porridge"
	description = "Commonly served aboard the Asian colonies, rice porridge with syrup is more palatable than the regular stuff, if even just because it's spicier than normal."
	data = list("sugar" = 1, "spice" = 1)
	color = "#D8CFCC"

/datum/glass_style/has_foodtype/soup/sweet_rice_porridge
	required_drink_type = /datum/reagent/consumable/nutriment/soup/sweet_rice_porridge
	name = "Sweet rice porridge"
	icon_state = "sweet_rice_porridge"
	drink_type = GRAIN | VEGETABLES

/datum/chemical_reaction/food/soup/sweet_rice_porridge
	required_reagents = list(
		/datum/reagent/consumable/nutriment/soup/rice_porridge = 20,
	...
	results = list(
		/datum/reagent/consumable/nutriment/soup/sweet_rice_porridge = 30,
		/datum/reagent/consumable/nutriment/protein = 6,
...
/datum/reagent/consumable/nutriment/soup/red_porridge
	name = "Red beet porridge"
	description = "Red porridge with yoghurt. The name and vegetable ingredients obscure the sweet nature of the dish."
