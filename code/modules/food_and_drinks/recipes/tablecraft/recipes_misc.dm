...
/datum/crafting_recipe/food/sweet_chili_cabbage_wrap
	...
	reqs = list(
		...
		/obj/item/food/salad/redgreen_salad = 1,
		/obj/item/food/grown/chili = 1,
		/obj/item/food/grown/cabbage = 1,
		/datum/reagent/consumable/honey = 5
	)
...
/datum/crafting_recipe/food/reaction/soup/oat_stew
	name = "Oat stew"
	reaction = /datum/chemical_reaction/food/soup/oat_stew
	category = CAT_MISCFOOD
...
/datum/crafting_recipe/food/reaction/soup/sweet_rice_porridge
	reaction = /datum/chemical_reaction/food/soup/sweet_rice_porridge
	category = CAT_MISCFOOD
...
/datum/crafting_recipe/food/poms_fries
	name = "Loaded poms-fries"
	reqs = list(
		/obj/item/food/fries = 1,
		/obj/item/food/meat/cutlet = 2,
	...
	result = /obj/item/food/poms_fries
	category = CAT_MISCFOOD
