...
/obj/item/gun/ballistic/automatic/smg
	...
	abstract_type = /obj/item/gun/ballistic/automatic/smg
	recoil = RECOIL_SMG


/obj/item/gun/ballistic/automatic/smg/c20r
	name = "\improper C-20r SMG"
	desc = "A bullpup three-round burst SMG, chambered in 8x22mm rounds."
	icon_state = "c20r"
	inhand_icon_state = "c20r"
	selector_switch_icon = TRUE
	accepted_magazine_type = /obj/item/ammo_box/magazine/smgm8mm_c20r
	burst_delay = 2
	burst_size = 3
...
/obj/item/gun/ballistic/automatic/smg/c20r/update_overlays()
	. = ..()
...
/obj/item/gun/ballistic/automatic/smg/c20r/Initialize(mapload)
	. = ..()
	update_appearance()

/obj/item/gun/ballistic/automatic/smg/c20r/brand/scarborough
	name = "\improper SC C-20r SMG"
	desc = "A bullpup three-round burst SMG. Has a 'Per falcis, per pravitas' buttstamp."
	manufacturer = CORPORATION_SCARBOROUGH_ARMS
	pin = /obj/item/firing_pin/implant/pindicate

/obj/item/gun/ballistic/automatic/smg/c20r/brand/scarborough/update_overlays()
	. = ..()
	. += "[icon_state]_sa"

/obj/item/gun/ballistic/automatic/smg/c20r/brand/solstice_reach
	name = "\improper SR C-20s SMG"
	desc = "A modified version of C-20r. Has longer barrel with no threads for suppressors."
	icon_state = "c20s-sr"
...
/obj/item/gun/ballistic/automatic/smg/wt550
	...
	desc = "A cheap self-defense weapon, designed for paramilitary and private use. \
		Light-weight and fully automatic."
	icon_state = "wt550"
	inhand_icon_state = "arg"
	w_class = WEIGHT_CLASS_BULKY
	accepted_magazine_type = /obj/item/ammo_box/magazine/smg46mm_wt550
	burst_delay = 2
	can_suppress = FALSE
	burst_size = 1
	actions_types = list()
...
/obj/item/gun/ballistic/automatic/smg/wt550/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/automatic_fire, 0.3 SECONDS)

/obj/item/gun/ballistic/automatic/smg/wt550/add_bayonet_point()
	AddComponent(/datum/component/bayonet_attachable, offset_x = 25, offset_y = 12)

/obj/item/gun/ballistic/automatic/smg/wt550/brand/ward_takahashi
	manufacturer = CORPORATION_WARD_TAKAHASHI

/obj/item/gun/ballistic/automatic/smg/wt550/brand/ward_takahashi/update_overlays()
	. = ..()
	. += "[icon_state]_ward"
...
/obj/item/gun/ballistic/automatic/smg/smartgun/fire_sounds()
...
/obj/item/gun/ballistic/automatic/assault_rifle
	...
	abstract_type = /obj/item/gun/ballistic/automatic/assault_rifle
	recoil = RECOIL_RIFLE
	w_class = WEIGHT_CLASS_BULKY
	weapon_weight = WEAPON_HEAVY
	slot_flags = ITEM_SLOT_BACK

/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle
	name = "\improper SR BR-38 battle rifle"
	desc = "Prototype security weapon chambered in .38 pistol rounds. Ignore that this makes it technically a carbine. \
		And that it functions as a designated marksman rifle. Marketing weren't being very co-operative when it came time to name the gun. \
		That, and the endless arguments in board rooms about exactly what designation the gun is meant to be."
	icon_state = "br38"
	inhand_icon_state = "br38"
	base_icon_state = "br38"
	worn_icon_state = "br38"
	manufacturer = CORPORATION_SOLSTICE_REACH
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/scope, range_modifier = 2)
	register_context()

/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/add_context(atom/source, list/context, obj/item/held_item, mob/user)
	. = ..()
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/examine_more(mob/user)
	. = ..()
	. += span_notice("<b><i>Looking down at \the [src], you recall something you read in a promotional pamphlet... </i></b>")

	. += span_info("The SR BR-38 possesses an acceleration rail that launches bullets at higher than typical velocity. \
	...
	. += span_notice("In a sour twist of irony for Nanotrasen's historical issues with ballistics-based security weapons, the SR BR-38 has one significant flaw. \
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/examine(mob/user)
	. = ..()
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/update_icon_state()
	. = ..()
	if(!shots_before_degradation)
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/update_overlays()
	. = ..()
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/emp_act(severity)
	. = ..()
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/emag_act(mob/user, obj/item/card/emag/emag_card)
	. = ..()
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/multitool_act(mob/living/user, obj/item/tool)
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/try_fire_gun(atom/target, mob/living/user, params)
	. = ..()
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/process_fire(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0)
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/proc/attempt_degradation(force_increment = FALSE)
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/proc/attempt_recalibration(restoring_shots_before_degradation = FALSE, recharge_rate = 1)
	emp_malfunction = FALSE
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/proc/perform_extreme_malfunction(mob/living/user)
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/proc/fucking_explodes_you()
...
/obj/item/gun/ballistic/automatic/assault_rifle/battle_rifle/add_seclight_point()
