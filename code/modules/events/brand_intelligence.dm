...
/datum/round_event/brand_intelligence/announce(fake)
	...
	priority_announce("Rampant brand intelligence has been detected aboard [ship_name()]. Please inspect any [machine_name] brand vendors for aggressive marketing tactics, and reboot them if necessary.", "Machine Learning Alert")
