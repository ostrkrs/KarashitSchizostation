...
/datum/round_event/disease_outbreak/announce(fake)
	...
	priority_announce("Confirmed outbreak of level 7 viral biohazard aboard [ship_name()]. All personnel must contain the outbreak.", "[illness_type] Alert", ANNOUNCER_OUTBREAK7)
