...
/obj/item/tape/captains_log
	...
	storedinfo = list( // the captain recorded this in several segements
		...
		"\[01:03\] A state of the art orbital phoron research facility",
		"\[01:10\] If I remember correctly though",
		"\[01:15\] It was all about the phoron",
		...
		"\[15:05\] So they give me a crew of scientists and engineers to research and harness this so called phoron",
		...
		"\[16:10\] What can be worse than a bunch of phoron-humping-space-freaks?",
		"\[16:17\] The syndicate",
		...
		"\[17:00\] Or wondering in awe at the promise phoron has to offer",
