...
/datum/smite/randomblooper
	name = "Random blooper"

/datum/smite/randomblooper/effect(client/user, mob/living/carbon/human/target)
	. = ..()
	target.blooper = null
	target.blooper_id = pick(GLOB.blooper_list)
...
/datum/preference/choiced/blooper/init_possible_values()
	return assoc_to_keys(GLOB.blooper_list_humans)
...
/// Can I send my own bloops to others?
