...
GLOBAL_LIST_INIT(exoscanner_bands,list(EXOSCANNER_BAND_PHORON=0,EXOSCANNER_BAND_LIFE=0,EXOSCANNER_BAND_TECH=0,EXOSCANNER_BAND_RADIATION=0,EXOSCANNER_BAND_DENSITY=0))
