...
/datum/species/human/get_species_lore()
	return list(
		...
		"В течение пары последних столетий, человечество колонизировало ближайшие и дальние, по другую сторону червоточин, \
		звездные системы, заселяя их генетически-модифицированными земными организмами, включая их самих, при необходимости. \
