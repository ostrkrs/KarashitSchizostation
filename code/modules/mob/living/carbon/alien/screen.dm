...
/mob/living/carbon/alien/proc/updatePhoronDisplay()
	if(hud_used) //clientless aliens
		hud_used.alien_phoron_display.maptext = MAPTEXT("<div align='center' valign='middle' style='position:relative; top:0px; left:6px'><font color='magenta'>[round(getPhoron())]</font></div>")
