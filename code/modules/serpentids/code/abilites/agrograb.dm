#define MARTIALART_SERPENTID "scythes grab"

/datum/martial_art/serpentid_grab
	name = "scythes grab"
	id = MARTIALART_SERPENTID

/datum/martial_art/serpentid_grab/grab_act(mob/living/attacker, mob/living/defender)
