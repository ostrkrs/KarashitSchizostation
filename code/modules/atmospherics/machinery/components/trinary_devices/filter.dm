...
/obj/machinery/atmospherics/components/trinary/filter/atmos/phoron
	name = "phoron filter"
	filter_type = list(/datum/gas/phoron)
...
/obj/machinery/atmospherics/components/trinary/filter/atmos/flipped/phoron
	name = "phoron filter"
	filter_type = list(/datum/gas/phoron)
